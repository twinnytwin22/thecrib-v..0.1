...
function TwinOnLenz() {
  return (
    ...
    <div className="gap-8 items-center justify-center content-center py-2 px-4 mx-auto max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2  lg:px-6">
        <img className="flex w-24 dark:hidden items-center justify-center content-center" src="/assets/lens_black.png" alt="lens logo"/>
        <img className="w-24 hidden dark:flex items-center justify-center content-center"  src="/assets/lens_white.png" alt="lens logo"/>
