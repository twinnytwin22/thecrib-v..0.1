    ...
    <div className=" mb-6 mt-3 lg:mb-12 mx-5 nd:mx-auto">
          <div className="items-center bg-gray-50 rounded-lg shadow flex flex-row dark:bg-gray-800 dark:border-gray-700">
              ...
              <div className="p-5">
                  ...
                  <span className="text-gray-500 dark:text-gray-400">Musician & Developer</span>
                  <p className="mt-3 mb-4 font-light text-gray-500 dark:text-gray-400">World builder & Creator of Crib Music</p>
