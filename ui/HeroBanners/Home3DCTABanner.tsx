    ...
    return (
      ...
      <div className="grid w-full px-4 py-16 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-2 md:grid-cols-1 whitespace-normal ">
          <div className="mx-10 place-self-center whitespace-normal">
              ...
              <Link href="/explore" className="inline-flex items-center justify-center px-5 py-3 text-base font-medium text-center  border border-gray-300 rounded-lg hover:bg-red-100 bg-red-700 focus:ring-4 focus:ring-gray-100 text-white dark:border-gray-700 dark:hover:bg-red-500 dark:focus:ring-gray-800">
