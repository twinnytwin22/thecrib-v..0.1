  ...
  export default function Hero3DCribBanner(settings: any) {
   const set = settings.settings.result[0]
    return (
      ...
      <div className="grid max-w-screen-xl px-4 py-16 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-2 md:grid-cols-1 whitespace-normal ">
          ...
          <div className="order-first lg:order-last animate-pulse hover:animate-none focus:animate-none ">
                <CribScene/>
          </div>                
      </div>
