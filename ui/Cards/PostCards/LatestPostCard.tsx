...
function LatestDropCard({image}: any) {
  return (
    <>
<div className="max-w-xs bg-white border border-gray-200 rounded-lg  dark:bg-gray-800 dark:border-gray-700 shadow-md">
    ...
    <div className="p-5">
      ...
      <img src={image} className="w-72 rounded-2xl mb-4"/></Link>
      <div className='flex justify-between'>
       <Link className='tex-lg font-extrabold' href ="/collection/twinny-always">View Drop</Link>
       <SocialShareRow/></div>
    </div>
</div>
</>
