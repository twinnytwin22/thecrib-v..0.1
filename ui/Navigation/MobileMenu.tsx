          ...
          <div className="block lg:hidden md:block px-5 bg-white dark:bg-black pb-2 w-[100vw] fixed bottom-0 inset-x-0">
            <div className="grid grid-cols-3 text-gray-800 dark:text-gray-400 justify-items-center pt-3">
                ...
                <div className="flex flex-row group items-center ">
                    <Link href="/explore" className="flex items-end justify-center items-center text-center mx-auto px-4 w-full text-gray-400 group-hover:text-red-500 border-b-2 border-transparent group-hover:border-red-500">
                ...
                <div className="flex group">
                    <Link href="/collectors" className="flex items-end justify-center text-center mx-auto px-4 w-full text-gray-400 group-hover:text-red-500 border-b-2 border-transparent group-hover:border-red-500">
                        <span className="px-1 flex flex-col items-center">
                        <div className="w-8">
                            <svg fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                            ...
                            <span className="block text-xs pb-1">Collectors</span>
                        </span>
                    </Link>
                </div>
            </div>
