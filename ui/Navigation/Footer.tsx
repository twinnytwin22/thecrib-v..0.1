    ...
    <footer className="p-4 bg-black shadow md:px-6 md:py-8 dark:bg-black">
      <div className="flex items-center justify-between">
        ...
        <ul className="flex flex-wrap items-center mb-6 text-sm text-gray-300 sm:mb-0 dark:text-gray-400 sm:hidden md:block">
          ...
          <li>
            <a href="/holder" className="hover:underline">
              Holders
            </a>
          </li>
          <li>
      ...
      <span className="block text-sm text-gray-300 sm:text-center dark:text-gray-300">
        © 2023{" "}
        <Link href="https://crib.sanity.studio/" className="hover:underline">
          THE CRIB™
        </Link>
        ,<Link href="https://thecrib.network">THE CRIB NETWORK</Link>.All Rights
        Reserved.
      </span>
    </footer>
  );
