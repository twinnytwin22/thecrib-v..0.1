    ...
    <div className="static gap-8 items-center py-8 px-4 mx-auto max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2 sm:py-16 lg:px-6">
       ...
       <>
        <div className="mt-4 md:mt-0">
            <h2 className="mb-4 text-4xl tracking-md font-extrabold text-gray-900 dark:text-white uppercase break-words text-justify leading-relaxed">{set.secondSectionHeaderText}</h2>
            <a href="#" className="inline-flex items-center text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:focus:ring-primary-900">
                Get started
