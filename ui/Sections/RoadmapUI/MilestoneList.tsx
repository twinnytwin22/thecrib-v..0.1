    ...
    <div className="mx-auto min-w-5xl max-w-8xl w-full items-center justify-center">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 drop-shadow-sm	">
        {quarters.map((quarter) => (
          <div
            key={quarter.id}
            className="bg-gray-100 dark:bg-gray-700 rounded-2xl p-6 drop-shadow-md"
          >
                  ...
                  <li className="mb-10 ml-6 w-full" key={milestone._id}>
                    {milestone.completed ? (
                      <Tooltip text="Completed!">
                        <span
                          style={{ cursor: "help" }}
                          className="absolute flex items-center justify-center w-6 h-6 rounded-full -left-9  bg-green-500"
                        >
                          <svg
                            aria-hidden="true"
                      ...
                      <Tooltip text="Pending">
                        <span
                          style={{ cursor: "help" }}
                          className="absolute flex items-center justify-center w-6 h-6 rounded-full -left-9  bg-gray-400"
                        >
                          <svg
                            aria-hidden="true"
                            className="w-3 h-3 text-gray-600 dark:text-gray-100"
                            fill="currentColor"
                            viewBox="0 0 20 20"
                            xmlns="http://www.w3.org/2000/svg"
                          >
                    ...
                    <div className="inline">
                      <p className="mb-4 mr-1 text-sm font-normal text-gray-500 dark:text-gray-300">
                        {milestone?.description}
                        {milestone?.url && (
                          <Link className="text-blue-400" href={milestone?.url}>
                            &nbsp;View
                          </Link>
                        )}
                      </p>
