...
const RoadMapItem = ({data}:any) => {
    ...
    return (
        <>
    {Array.from([...data]).map((e: any, i: any) => { 
            <li className="mb-10 ml-6">         
         <div key={i}>{e && console.log(e.title, "title")}</div> 
            ...
            <h3 className="flex items-center mb-1 text-lg font-semibold text-gray-900 dark:text-white"><span className="bg-blue-100 text-blue-800 text-sm font-medium mr-2 px-2.5 py-0.5 rounded dark:bg-blue-900 dark:text-blue-300 ml-3">Latest</span></h3>
            ...
            <p className="mb-4 text-base font-normal text-gray-500 dark:text-gray-400">Description here</p>
