...
function getEntryModule(options) {
  ...
  return sourceModule.replace(/%STUDIO_REACT_STRICT_MODE%/, JSON.stringify(Boolean(reactStrictMode))).replace(/%STUDIO_CONFIG_LOCATION%/, JSON.stringify(relativeConfigLocation));
}
...
//# sourceMappingURL=runtime-061fef02.js.map
