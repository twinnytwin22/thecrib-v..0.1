...
async function getBuildAction() {
  const mod = await Promise.resolve().then(function () {
    return require('./buildAction-0797afd8.js');
  });
  return mod.default;
}
const checkCommand = {
...
const deployCommand = {
  ...
  action: async (args, context) => {
    const mod = await Promise.resolve().then(function () {
      return require('./deployAction-8497fbea.js');
    });
...
async function getDevAction() {
  const mod = await Promise.resolve().then(function () {
    return require('./devAction-c2147bc0.js');
  });
  return mod.default;
}
...
async function getPreviewAction$1() {
  const mod = await Promise.resolve().then(function () {
    return require('./previewAction-a8e7e380.js');
  });
  return mod.default;
}
...
const deployGraphQLAPICommand = {
  ...
  action: async (args, context) => {
    const mod = await Promise.resolve().then(function () {
      return require('./deployApiAction-9324dba7.js');
    });
    return mod.default(args, context);
  },
  helpText: helpText$3
...
exports.debug = debug;
//# sourceMappingURL=_internal-0ee4475e.js.map
