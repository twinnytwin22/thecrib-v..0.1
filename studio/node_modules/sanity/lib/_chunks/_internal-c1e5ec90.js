...
async function getBuildAction() {
  const mod = await import('./buildAction-5e9b40e6.js');
  return mod.default;
}
const checkCommand = {
  name: "check",
...
const deployCommand = {
  ...
  action: async (args, context) => {
    const mod = await import('./deployAction-92be7c78.js');
...
async function getDevAction() {
  const mod = await import('./devAction-bcce7002.js');
  return mod.default;
}
...
async function getPreviewAction$1() {
  const mod = await import('./previewAction-641f27a7.js');
  return mod.default;
}
...
const deployGraphQLAPICommand = {
  ...
  action: async (args, context) => {
    const mod = await import('./deployApiAction-d998ec4b.js');
    return mod.default(args, context);
  },
  helpText: helpText$3
};
...
//# sourceMappingURL=_internal-c1e5ec90.js.map
