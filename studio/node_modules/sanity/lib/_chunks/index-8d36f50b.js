...
const ReferenceChangedBanner = React.memo(() => {
  ...
  const referenceInfo = reactRx.useMemoObservable(() => {
    ...
    operators.debounceTime(750), operators.map(_ref25 => {
      let {
        draft,
        published
      } = _ref25;
...
//# sourceMappingURL=index-8d36f50b.js.map
