...
return (
    ...
    <div className='bg-cover w-screen mx-auto' style={{ backgroundImage: `url(${bgImage})`, backgroundPosition: 'center', backdropFilter: 'blur(8px)',}}>
    <div className='grid max-w-screen px-10 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 sm:gap-8 md:gap-8 lg:grid-cols-12' style={{ backgroundImage: `url(${bgImage})`, backgroundPosition: 'center', backdropFilter: 'blur(8px)',}}>
