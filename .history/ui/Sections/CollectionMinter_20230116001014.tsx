...
const CollectionMinter = (collection: any) => {
    ...
    async function handleMint() {
        if(window.ethereum) {
            ...
            try {
                const response = await contractInstance.mintTwins(address?.toString(), BigNumber.from(mintAmount), {
    ...
    {isConnected && mintStatus ? (
        ...
        <><div className='flex flex-row justify-center justify-start'>
                            ...
                            <button className="text-white bg-red-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800"
                                ...
                                {currentCollection.title = "Super" && <button className="text-white bg-red-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800"
