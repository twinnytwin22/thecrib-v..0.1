...
return (
    ...
    <div className='bg-cover w-screen mx-auto' style={{ backgroundImage: `url(${bgImage})`, backgroundPosition: 'center', backdropFilter: 'blur(8px)', WebkitFilter: 'blur(8px)' , zIndex: 0}}>
