  ...
  export default function Hero3DCribBanner(settings: any) {
   const set = settings.settings.result[0]
    return (
      ...
      <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-2 md:grid-cols-1 whitespace-normal ">
          <div className="mr-auto place-self-center whitespace-normal">
              ...
              <a href="/holder" className="inline-flex items-center justify-center px-5 py-3 mr-3 text-black font-medium text-center dark:text-white rounded-lg bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:focus:ring-primary-900">
                  I'm a collector
          ...
          <div className="lg:mt-0 lg:min-w-96 lg:h-96 md:min-w-36 md:h-36 sm:mt-8">
                <CribScene/>
          </div>                
      </div>
