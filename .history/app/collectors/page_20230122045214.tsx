import { getAllCollections, getAllContracts } from 'lib/hooks/get-collection-data'
...
export async function getAllThemThangs() {
  const res =  getAllCollections()
  return res
}


 export async function Collectors(res: any) {
