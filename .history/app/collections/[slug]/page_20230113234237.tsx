...
import { fetchNFTsForCollection, getAllSlugs, getOwnerForEthCollection, fetchCollectionOS } from 'lib/hooks/get-collection-data';
...
async function SingleCollection(params: any) {
  ...
  const blockchain = collection?.chain
  ...
  const collectors = await getOwnerForEthCollection(contract);
