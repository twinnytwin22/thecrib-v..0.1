...
<div className="flex flex-col items-center ">
        <div className="flex flex-row">
          <p className="text-sm text-gray-700 dark:text-gray-400">Showing</p>
          <p className="font-semibold text-gray-900 dark:text-white">{currentPage * itemsPerPage - 10}   </p>
         <p className="text-sm text-gray-700 dark:text-gray-400">of</p>
         <p className="font-semibold text-gray-900 dark:text-white">{currentPage * itemsPerPage} </p>
         <p className="text-sm text-gray-700 dark:text-gray-400">of</p>
         <p className="font-semibold text-gray-900 dark:text-white">{totalItems} </p>
         <p className="text-sm text-gray-700 dark:text-gray-400"> results</p>
</div>
