...
export async function getAllContracts() {
  const res = await fetch(`https://${projectId}.api.sanity.io/v${apiVersion}/data/query/${dataset}?query=*%5B_type%20%3D%3D%20%22collection%22%5D%7Bcontract%7D`, {cache: 'force-cache'})
  return res.json()
}
...
export async function getCribNfts(address: string){
const contracts = await getAllContracts()
const res = await fetch(`https://eth-mainnet.g.alchemy.com/nft/v2/${ethApiKey}/getNFTs?owner=${address}&pageSize=100&ContractAddresses[]=0x148280a1395af6F430248c2E4B8063c69B7cA23E&contractAddresses[]=%5B0x148280a1395af6F430248c2E4B8063c69B7cA23E&withMetadata=false&excludeFilters[]=`, getRequestOptions)
return res.json()
}