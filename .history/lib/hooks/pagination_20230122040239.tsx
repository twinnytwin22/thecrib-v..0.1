...
<div className="flex flex-col items-center ">
    <div className="flex flex-row">
          <div className="text-sm text-gray-700 dark:text-gray-400 p-1">Showing</div>
          <div className="font-semibold text-gray-900 dark:text-white p-1">{currentPage * itemsPerPage - 10}   </div>
          <div className="text-sm text-gray-700 dark:text-gray-400 p-1">of</div>
          <div className="font-semibold text-gray-900 dark:text-white p-1">{currentPage * itemsPerPage} </div>
          <div className="text-sm text-gray-700 dark:text-gray-400 p-1">of</div>
          <div className="font-semibold text-gray-900 dark:text-white p-1">{totalItems} </div>
          <div className="text-sm text-gray-700 dark:text-gray-400 p-1"> results</div>
</div>
