...
export async function getCribNfts(){
const res = await fetch(`https://eth-mainnet.g.alchemy.com/nft/v2/${ethApiKey}/getNFTs?owner=vitalik.eth&pageSize=100&contractAddresses[]=0x148280a1395af6F430248c2E4B8063c69B7cA23E&withMetadata=false&excludeFilters[]=&orderBy=transferTime`, getRequestOptions)
return res.json()
}