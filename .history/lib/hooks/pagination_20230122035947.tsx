...
<div className="flex flex-col items-center ">
    <div className="flex flex-row grid grid-cols-8 gap-2">
          <div className="text-sm text-gray-700 dark:text-gray-400 cols-span-1">Showing</div>
          <div className="font-semibold text-gray-900 dark:text-white">{currentPage * itemsPerPage - 10}   </div>
          <div className="text-sm text-gray-700 dark:text-gray-400">of</div>
          <div className="font-semibold text-gray-900 dark:text-white">{currentPage * itemsPerPage} </div>
          <div className="text-sm text-gray-700 dark:text-gray-400">of</div>
          <div className="font-semibold text-gray-900 dark:text-white">{totalItems} </div>
          <div className="text-sm text-gray-700 dark:text-gray-400"> results</div>
</div>
