...
const res = await fetch(`https://eth-mainnet.g.alchemy.com/nft/v2/${ethApiKey}/getNFTs?owner=${address}&pageSize=100&contractAddresses[]=0x148280a1395af6F430248c2E4B8063c69B7cA23E&%5B0x148280a1395af6F430248c2E4B8063c69B7cA23E&withMetadata=false&excludeFilters[]=`, getRequestOptions)
return res.json()
}