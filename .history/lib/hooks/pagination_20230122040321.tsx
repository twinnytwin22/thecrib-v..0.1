...
<div className="flex flex-col items-center ">
    <div className="flex flex-row">
          <div className="text-sm text-gray-700 dark:text-gray-400 pr-2">Showing</div>
          <div className="font-semibold text-gray-900 dark:text-white pr-2">{currentPage * itemsPerPage - 10}   </div>
          <div className="text-sm text-gray-700 dark:text-gray-400 pr-2">of</div>
          <div className="font-semibold text-gray-900 dark:text-white pr-2">{currentPage * itemsPerPage} </div>
          <div className="text-sm text-gray-700 dark:text-gray-400 pr-2">of</div>
          <div className="font-semibold text-gray-900 dark:text-white pr-2">{totalItems} </div>
          <div className="text-sm text-gray-700 dark:text-gray-400 pr-2"> results</div>
</div>
