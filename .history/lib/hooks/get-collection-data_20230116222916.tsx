...
const contracts = Object.values(allContracts).map((i: any) => i)
const res = await fetch(`https://eth-mainnet.g.alchemy.com/nft/v2/${ethApiKey}/getNFTs?owner=${address}&pageSize=100&contractAddresses=${contracts}&withMetadata=false&excludeFilters[]=&orderBy=transferTime`, getRequestOptions)
return res.json()
}